...
const footerLinks = [
    {
        ...
        links: [
            ...
            { label: 'Bande Dessinée', href: '/courses?category=Bande%20Dessin%C3%A9e' },
        ...
        >
            ...
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
                    ...
                    >
                        ...
                        <p className="mb-4 max-w-md text-sm text-muted-foreground">
                            Liberty Creativity School est la plateforme de formation premium pour les créateurs qui veulent acquérir de réelles compétences et transformer leur passion en métier.
                        </p>
                ...
                <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                    ...
                    >
                        <span>© 2026 Liberty Creativity School. Tous droits réservés.</span>
