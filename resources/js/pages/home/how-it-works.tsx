                ...
                <div className="mx-auto max-w-7xl px-6 py-12 md:px-8 lg:px-12">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <p className="text-lg text-muted-foreground">
                            Liberty Creativity School est une plateforme d'apprentissage moderne qui connecte des formateurs qualifiés et professionnels avec des personnes souhaitant acquérir des compétences concrètes dans les métiers de la création.
                        </p>
                    </div>
                    ...
                    {/* Trainer Section */}
                    <div className="mb-24">
                        <h2 className="text-3xl font-semibold text-foreground mb-12 text-center">Vous êtes formateur / professionnel</h2>
                        <motion.div 
                            variants={containerVariants}
                            initial="hidden"
                            whileInView="visible"
                    ...
                    <div className="rounded-3xl border border-border/40 bg-background/60 p-8 md:p-12 text-center backdrop-blur-sm max-w-4xl mx-auto shadow-md">
                        <h3 className="text-2xl font-semibold text-foreground mb-4">Prêt à commencer votre apprentissage ?</h3>
                        <p className="text-muted-foreground max-w-xl mx-auto mb-8">
                            Rejoignez dès aujourd'hui des milliers d'étudiants engagés sur la voie du succès et de l'acquisition de compétences réelles.
                        </p>
